...
class RPE_NET(nn.Module):
    ...
    def forward(self, nodes, features, adj_list, curr_neigh, curr_embed, curr_target, layer, l_range, n_sample):
        ...
        '''
        Cora --- 
                layer = 2  ===>  l_range = 1, n_sample = 5
                layer = 4  ===>  l_range = 3, n_sample = 3
                layer = 8  ===>  l_range = 3, n_sample = 3
                layer = 16 ===>  l_range = 3, n_sample = 3
                layer = 32 ===>  l_range = 3, n_sample = 4 
                layer = 64 ===>  l_range = 4, n_sample = 3

        Citeseer --- 
                layer = 2 ===>  l_range = 1, n_sample = 10
                layer = 4 ===>  l_range = 4, n_sample = 4
                layer = 8 ===>  l_range = 4, n_sample = 4
                layer = 16 ===> l_range = 4, n_sample = 4
                layer = 32 ===> l_range = 4, n_sample = 4
                layer = 64 ===> l_range = 4, n_sample = 3

        Pubmed --- 
                layer = 2 ===>  l_range = 1, n_sample = 3
                layer = 4 ===>  l_range = 2, n_sample = 3
                layer = 8 ===>  l_range = 3, n_sample = 4
                layer = 16 ===> l_range = 3, n_sample = 3
                layer = 32 ===> l_range = 3, n_sample = 3
                layer = 64 ===> l_range = 2, n_sample = 3 

        CoauthorCS --- 
                layer = 2 ===>  l_range = 1, n_sample = 4
                layer = 4 ===>  l_range = 2, n_sample = 2
                layer = 8 ===>  l_range = 3, n_sample = 3
                layer = 16 ===> l_range = 2, n_sample = 2
                layer = 32 ===> l_range = 1, n_sample = 4
                layer = 64 ===> l_range = 1, n_sample = 4
        '''
...
class RPE_GNN(nn.Module):
    ...
    def __init__(self, data_obj, num_layers, hidden_dim, device):
    ...
    def forward(self, nodes_batch, adj_list, l_range, n_sample):
        ...
        for i in range(self.num_layers):
            ...
            if i != self.num_layers - 1:
                ...
                curr_embed = F.dropout(curr_embed, p = 0.50, training = self.training)
